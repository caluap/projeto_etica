...
A primeira hipótese a ser testada é que a relação entre o áudio da voz e suas correspodentes modificações visuais na tipografia será suficientemente auto-explicativa a ponto de que um participante da avaliação, não tendo tido treinamento prévio, conseguirá identificar quais modulações visuais correspondem à fala que acaba de ouvir.

A segunda hipótese a ser testada é que essas modificações aumentarão a imersão do participante em uma dada obra audiovisual, medida especificamente por ganhos em medidas como \textit{transporte}, \textit{identificação com as personagens} e \textit{realismo percebido}.
